...
//CAN
void updateAmplifierStatus(can &amplifierCan );

//////////////////////////////////////////////////////////

void initialize(can &amplifierCan) {
    ...
    amplifierLedOn();
    amplifierLedOff();
    updateAmplifierStatus(amplifierCan);
...
void updateAmplifierStatus(can &amplifierCan ) {
    uint16_t valeur = amplifierCan.lecture(CAN_INPUT_BIT);
